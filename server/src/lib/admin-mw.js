...
const ROLE_PERMISSIONS = Object.freeze({
  SUPER_ADMIN: ['*'],
  OPERATOR: [
    'CUSTOMER_SERVICE', 'ANNOUNCEMENT_MANAGE',
    'CAMPAIGN_MANAGE', 'HELP_MANAGE', 'SUPPORT_MANAGE',
  ...
  ARBITER: ['DASHBOARD_READ', 'USER_READ', 'ORDER_READ', 'DISPUTE_READ', 'DISPUTE_RESOLVE', 'SUPPORT_MANAGE', 'CUSTOMER_SERVICE', 'AUDIT_READ'],
  FINANCE: ['DASHBOARD_READ', 'ORDER_READ', 'FINANCE_READ', 'WALLET_MANAGE', 'INVOICE_READ', 'INVOICE_PROCESS', 'AUDIT_READ'],
