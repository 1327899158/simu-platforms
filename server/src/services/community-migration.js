'use strict';
const definitions = [
  `CREATE TABLE IF NOT EXISTS demo_wallets (userId VARCHAR(32) PRIMARY KEY,availableFen BIGINT NOT NULL DEFAULT 0,frozenFen BIGINT NOT NULL DEFAULT 0,updatedAt DATETIME(3) NOT NULL)`,
  `CREATE TABLE IF NOT EXISTS demo_wallet_ledger (id VARCHAR(32) PRIMARY KEY,userId VARCHAR(32) NOT NULL,businessKey VARCHAR(100) NOT NULL,kind VARCHAR(24) NOT NULL,deltaAvailable BIGINT NOT NULL,deltaFrozen BIGINT NOT NULL,availableAfter BIGINT NOT NULL,frozenAfter BIGINT NOT NULL,note VARCHAR(300) NOT NULL,createdAt DATETIME(3) NOT NULL,UNIQUE KEY uq_demo_ledger(userId,businessKey),INDEX idx_demo_ledger(userId,createdAt))`,
  `CREATE TABLE IF NOT EXISTS demo_bank_cards (id VARCHAR(32) PRIMARY KEY,userId VARCHAR(32) NOT NULL,bankName VARCHAR(50) NOT NULL,lastFour CHAR(4) NOT NULL,status VARCHAR(16) NOT NULL,createdAt DATETIME(3) NOT NULL,INDEX idx_demo_card(userId))`,
  `CREATE TABLE IF NOT EXISTS demo_withdrawals (id VARCHAR(32) PRIMARY KEY,userId VARCHAR(32) NOT NULL,businessKey VARCHAR(64) NOT NULL,cardId VARCHAR(32) NOT NULL,bankLabel VARCHAR(80) NOT NULL,amountFen BIGINT NOT NULL,status VARCHAR(24) NOT NULL,note VARCHAR(300) NOT NULL DEFAULT '',createdAt DATETIME(3) NOT NULL,updatedAt DATETIME(3) NOT NULL,UNIQUE KEY uq_demo_withdraw(userId,businessKey),INDEX idx_demo_withdraw(userId,createdAt))`,
  `CREATE TABLE IF NOT EXISTS demo_wallet_holds (id VARCHAR(32) PRIMARY KEY,userId VARCHAR(32) NOT NULL,withdrawalId VARCHAR(32) NOT NULL UNIQUE,amountFen BIGINT NOT NULL,status VARCHAR(20) NOT NULL,createdAt DATETIME(3) NOT NULL,updatedAt DATETIME(3) NOT NULL)`,
  `CREATE TABLE IF NOT EXISTS demo_withdrawal_events (id VARCHAR(32) PRIMARY KEY,withdrawalId VARCHAR(32) NOT NULL,status VARCHAR(24) NOT NULL,note VARCHAR(300) NOT NULL,actorId VARCHAR(32) NOT NULL,createdAt DATETIME(3) NOT NULL)`,
  `CREATE TABLE IF NOT EXISTS user_coupons (id VARCHAR(32) PRIMARY KEY,userId VARCHAR(32) NOT NULL,offerKey VARCHAR(32) NOT NULL,title VARCHAR(100) NOT NULL,amountFen INT NOT NULL,minSpendFen INT NOT NULL,status VARCHAR(16) NOT NULL DEFAULT 'RESERVED',expiresAt DATETIME(3) NOT NULL,createdAt DATETIME(3) NOT NULL,UNIQUE KEY uq_coupon_claim(userId,offerKey))`,
  `CREATE TABLE IF NOT EXISTS achievement_showcase (userId VARCHAR(32) NOT NULL,taskKey VARCHAR(32) NOT NULL,createdAt DATETIME(3) NOT NULL,PRIMARY KEY(userId,taskKey))`,
